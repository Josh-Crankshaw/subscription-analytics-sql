/*
Query Name: Cohort Retention by Month
Purpose: Measure monthly retention for each subscription cohort across 2025.
Business Question: How well does each monthly cohort retain subscriptions over time?
Tables Used:
  - subscriptions
Key Columns Used:
  - subscription_id
...
Assumptions:
  ...
  - A subscription is counted as retained in a month if it was active at any point during that month
...
cohort_sizes AS (
    ...
    GROUP BY subscription_cohorts.cohort_month
),
